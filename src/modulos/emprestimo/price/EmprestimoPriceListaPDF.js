...
import './EmprestimoPriceListaPDF.css'
	...
	// },
          table: {
            ...
            body: [
                ...
                [ 'Qtde meses (Desmbolso):', {text: convertToReal(formData.desembolsooMeses), style: {alignment: 'right'}}, '',
                  'Desmbolso Mensal:', {text: convertToReal(formData.desembolsooValor), style: {alignment: 'right'}}],
          ...
          },
          {
              ...
              table: {
                ...
                body: [
                      ...
                      {text: 'Desembolso', style: {alignment: 'right'}}, {text: 'Amortização', style: {alignment: 'right'}}, {text: 'Saldo', style: {alignment: 'right'}}],
                      ...planData
                    ]
                },
